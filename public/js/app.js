...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_user_Users__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__actions_authActions__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_auth_Login__ = __webpack_require__(58);
...
Object(__WEBPACK_IMPORTED_MODULE_3__actions_authActions__["a" /* login */])({
    email: 'test@gmail.om',
    password: '12345678'
});
var AppRoot = function AppRoot() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        null,
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__components_auth_Login__["a" /* default */], null)
    );
};
...
if (localStorage.getItem('jwtToken')) {
    AppRoot = function AppRoot() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
            null,
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__components_user_Users__["a" /* default */], null)
        );
    };
}

if (document.getElementById('app')) {
    __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(AppRoot, null), document.getElementById('app'));
}
...
function login(data) {
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('http://127.0.0.1:8000/api/login', data).then(function (res) {
        console.log(res);
...
function register(data) {
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('127.0.0.1:8000/api/register', data).then(function (res) {
        console.log(res);
        var token = res.token;
        localStorage.setItem('jwtToken', token);
    });
